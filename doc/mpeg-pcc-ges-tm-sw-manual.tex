...
\title{GeS-TM v3: User manual of Test Model v3 for Geometry-based Solid
        point cloud coding}
\author{%
  Jonathan Taquet
...
\texttt{GeS-TM}. It applies to version 3 of the software.
\end{abstract}
