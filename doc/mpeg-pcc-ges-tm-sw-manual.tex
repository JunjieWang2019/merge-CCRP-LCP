...
\title{GeS-TM v5: User manual of Test Model v5 for Geometry-based Solid
        point cloud coding}
\author{%
  Jonathan Taquet
...
\texttt{GeS-TM}. It applies to version 5 of the software.
\end{abstract}
