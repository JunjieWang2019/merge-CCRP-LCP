...
\title{GeS-TM v1: User manual of Geometry-based Solid
        point cloud coding test model version 1}
\author{%
	Sébastien Lasserre
	\email{slasserre@ofinno.com}
}

\mpegmeeting{Online -- January 2023}
\mpegdocnum{N00558}
\mpegdocstatus{Approved}
\mpegdocsource{WG7, MPEG 3D Graphics Coding and Haptics}
\mpegdocserialnumber{22488}
...
\texttt{GeS-TM}. It applies to version 1 of the software.
\end{abstract}
