...
\title{GeS-TM v4: User manual of Test Model v4 for Geometry-based Solid
        point cloud coding}
\author{%
  Jonathan Taquet
...
\texttt{GeS-TM}. It applies to version 4 of the software.
\end{abstract}
