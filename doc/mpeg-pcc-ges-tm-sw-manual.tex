...
\title{GeS-TM v6: User manual of Test Model v6 for Geometry-based Solid
        point cloud coding}
\author{%
  Jonathan Taquet
...
\texttt{GeS-TM}. It applies to version 6 of the software.
\end{abstract}
